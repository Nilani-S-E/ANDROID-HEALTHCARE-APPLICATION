...
public class Database extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String qry3="create table orderplace(username text, fullname text, address text, contactnumber text, pincode int, date text, time text, amount float, otype text)";
